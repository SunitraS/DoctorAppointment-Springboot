...
public class ControllerClass {
	...
	@GetMapping("/editDoctorProfile")
	public ModelAndView editDoctorProfile(HttpSession session) {
	    ModelAndView mav = new ModelAndView("editProfile");
	    String email = (String) session.getAttribute("doctor");
	    Optional<Doctor> doctor = docRepo.findById(email);
	    if (doctor.isPresent()) {
	...
	public String updateDoctorProfile(Doctor updatedDoctor, HttpSession session) {
	    String email = (String) session.getAttribute("doctor");
	    Optional<Doctor> doctor = docRepo.findById(email);
	    if (doctor.isPresent()) {
